...
- לעולם אל תמלא מחירים, אחוזי הנחה, פיקדונות, מספרי משתתפים או תאריכים.
- אל תוסיף אימוג'ים בשדות הטקסט.
- תיאור מקצועי: 2-4 משפטים קצרים. בלי סופרלטיבים ריקים.
- "מה כלול" / "מה לא כלול": פריטים קצרים (2-6 מילים), רק אם ברור מההקשר.
- highlights: 2-4 משפטים קצרים ומדויקים (עד 6 מילים כל אחד).
- faq: 2-4 שאלות רלוונטיות עם תשובות קצרות.`;
}
