CREATE OR REPLACE FUNCTION public.save_supplier_onboarding(_business_name text, _contact_name text DEFAULT NULL::text, _phone text DEFAULT NULL::text, _email text DEFAULT NULL::text, _short_description text DEFAULT NULL::text, _category_ids text[] DEFAULT '{}'::text[], _serves_all_country boolean DEFAULT false, _region_ids uuid[] DEFAULT '{}'::uuid[], _city_ids uuid[] DEFAULT '{}'::uuid[], _logo_url text DEFAULT NULL::text)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
