...
const RESIDENT_FAQS: Faq[] = [
  ...
  { q: "איך מצטרפים לעסקה?", a: "נכנסים לאפליקציה, בוחרים פרויקט וקטגוריה, מעיינים בעסקאות זמינות ולוחצים \"הצטרף\". בעת ההצטרפות משלמים דמי השתתפות לפי מחיר העסקה." },
  { q: "מהם דמי השתתפות?", a: "דמי השתתפות הם תשלום חד-פעמי לפלטפורמה עבור ניהול הקבוצה ושמירת המקום. הסכום נקבע לפי מדרגות מחיר העסקה ומוצג לפני התשלום." },
  { q: "איך מבטלים חשבון?", a: "אפשר למחוק חשבון ישירות מהמסך \"החשבון שלי\", או לשלוח בקשה ל-support@groupbuild.co.il." },
  { q: "האם השירות בתשלום?", a: "השימוש באפליקציה חינמי לדיירים. בעת הצטרפות לעסקאות קבוצתיות נגבים דמי השתתפות לפי מדרגות מחיר." },
];
...
const SUPPLIER_FAQS: Faq[] = [
  ...
  { q: "מהם דמי ההשתתפות של הדיירים?", a: "דיירים משלמים דמי השתתפות לפלטפורמה לפי מדרגות מחיר העסקה. התשלום מאפשר הצטרפות לעסקה ואינו מהווה מקדמה לספק." },
