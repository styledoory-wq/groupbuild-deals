    ...
    <MobileShell>
      ...
      >
        <div className="pointer-events-auto w-full max-w-screen-sm px-4 pt-5 pb-2 bg-gradient-to-t from-[#F8F8F6] via-[#F8F8F6]/95 to-transparent">
          {interested ? (
            <div className="flex items-center gap-2.5 bg-[#C9A227] text-white p-3.5 rounded-2xl shadow-[0_12px_28px_-10px_rgba(10,31,61,0.6)]">
            ...
            <div className="flex items-stretch gap-2">
              <Button
                ...
                className="flex-1 h-14 rounded-2xl bg-[#C9A227] hover:bg-[#C9A227]/95 text-white font-extrabold text-[15px] shadow-[0_12px_28px_-10px_rgba(10,31,61,0.6)] border border-[#C9A227]/40"
              >
                {submittingInterest ? (
        ...
        <DialogContent dir="rtl" className="text-right max-h-[90vh] overflow-y-auto">
          ...
          <DialogFooter className="gap-2 sm:gap-2 mt-2">
            ...
            <Button
              ...
              className="rounded-xl bg-[#C9A227] text-white font-bold"
            >
              {submittingInterest ? (
        ...
        <DialogContent dir="rtl" className="text-right max-w-sm">
          ...
          <div className="grid grid-cols-1 gap-2 mt-2">
            ...
            <a
              ...
              onClick={() => setShareOpen(false)}
              className="h-12 rounded-xl bg-[#C9A227] text-white font-bold flex items-center justify-center gap-2 hover:opacity-90 transition"
            >
