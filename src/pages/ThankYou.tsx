      ...
      <div className="w-full max-w-screen-sm flex flex-col">
        ...
        <header className="px-5 h-14 flex items-center border-b border-white/5">
          <div className="flex items-center gap-2">
            <div className="h-8 w-8 rounded-xl bg-[#C9A227] text-white flex items-center justify-center">
        ...
        <main className="flex-1 px-6 pt-12 pb-10 flex flex-col items-center text-center">
          <div className="relative mb-8">
            ...
            <div className="relative h-24 w-24 rounded-full bg-[#C9A227] text-white flex items-center justify-center shadow-[0_8px_20px_-10px_rgba(10,31,61,0.45)] animate-fade-up">
          ...
          <div className="w-full space-y-3 mb-10">
            {[
              ...
              <div key={s.n} className="flex gap-3 items-start text-right bg-white/5 border border-white/10 rounded-2xl p-4">
                <div className="shrink-0 h-8 w-8 rounded-full bg-[#C9A227] text-white font-extrabold flex items-center justify-center text-sm">
                  {s.n}
                </div>
          ...
          <Button
            onClick={() => navigate("/")}
            className="w-full h-12 rounded-2xl bg-[#C9A227] text-white hover:opacity-90 font-bold shadow-[0_8px_20px_-10px_rgba(10,31,61,0.45)] flex items-center justify-center gap-2"
          >
