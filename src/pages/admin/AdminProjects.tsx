      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent dir="rtl" className="max-w-md">
                ...
                {(Object.keys(statusLabel) as ProjectStatus[]).map((st) => (
                  <button
                    ...
                    className={
                      ...
                      (form.status === st
                        ? "bg-[#C9A227] text-white border-[#1F2937]"
          ...
          <DialogFooter className="mt-4 gap-2 sm:gap-2">
            ...
            <button onClick={save} disabled={saving} className="h-10 px-4 rounded-[12px] bg-[#C9A227] text-white text-sm font-bold flex-1 disabled:opacity-50">
