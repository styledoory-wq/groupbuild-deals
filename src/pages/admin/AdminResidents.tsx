        ...
        {residents.map((r) => {
          ...
          return (
            <div key={r.id} className="gb-card p-3 flex items-center gap-3">
              <div className="h-11 w-11 rounded-full bg-[#0A1F3D] text-white flex items-center justify-center text-primary font-bold">
                {initial}
              </div>
            ...
            <div className="border-t border-border pt-3">
              <div className="flex items-center justify-between mb-2">
                <Label className="text-xs flex items-center gap-1.5">
                  <Building2 className="h-3.5 w-3.5 text-[#D4AF37]" /> פרויקט
                </Label>
                <button
                  type="button"
