...
>(({ className, ...props }, ref) => (
  <div className="flex items-center px-3 shadow-[0_1px_0_rgba(10,31,61,0.06)]" cmdk-input-wrapper="">
    <Search className="mr-2 h-4 w-4 shrink-0 opacity-50" />
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "flex h-12 w-full rounded-[16px] bg-transparent py-3 text-[14px] font-medium outline-none placeholder:text-[#9CA3AF] disabled:cursor-not-allowed disabled:opacity-50",
        className,
      )}
      {...props}
    />
