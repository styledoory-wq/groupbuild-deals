...
export function SearchInput({
  ...
  const stickyStyle: React.CSSProperties = sticky
    ? {
        ...
        background: "linear-gradient(180deg,#E8ECF0 60%, rgba(247,248,250,0))",
    ...
    <div className={wrap} style={stickyStyle}>
      <div className="relative">
        ...
        <input
          ...
          className="w-full h-12 pr-11 pl-10 rounded-[16px] bg-white text-[14px] font-medium text-[#0A1F3D] placeholder:text-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-[#D4AF37]/40 shadow-[0_2px_10px_-4px_rgba(10,31,61,0.08)]"
        />
        {value && (
          <button
            type="button"
