  ...
  return (
    ...
    >
      <div className="pointer-events-auto w-full max-w-[480px] px-3 pb-3 safe-bottom">
        <div className="bg-card/95 backdrop-blur border border-border shadow-elevated rounded-3xl px-2 py-2 flex items-center justify-between">
          {items[role].map(({ to, label, icon: Icon }) => {
            ...
            return (
              <NavLink
                ...
                to={to}
                className={cn(
                  "flex-1 flex flex-col items-center gap-1 py-2 rounded-2xl transition-smooth",
