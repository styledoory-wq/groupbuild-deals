  ...
  return (
    <div className="min-h-screen flex justify-center relative overflow-hidden ios-bg">
      ...
      <div aria-hidden className="pointer-events-none fixed inset-0 -z-0">
        <div className="absolute -top-32 -right-24 h-80 w-80 md:h-[28rem] md:w-[28rem] rounded-full bg-[#C9A961]/[0.10] blur-3xl gb-float" />
        <div className="absolute top-1/3 -left-24 h-96 w-96 md:h-[32rem] md:w-[32rem] rounded-full bg-[#0A1F3D]/[0.06] blur-3xl" />
        <div className="absolute bottom-10 right-0 h-72 w-72 md:h-[24rem] md:w-[24rem] rounded-full bg-[#C9A961]/[0.06] blur-3xl" />
        <div
